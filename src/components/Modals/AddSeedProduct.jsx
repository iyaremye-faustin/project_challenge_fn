            ...
            <form className="flex flex-col gap-2 w-full " onSubmit={handleRegister}>
              ...
              <div className="flex flex-colgap-4">
                <div className="flex flex-col items-start gap-1 w-full">
                  ...
                  <textarea onChange={updateFormData} className='border-[1px] border-grayText/40 rounded-[6px] w-full p-2 outline-none' placeholder='Add your Commnet' name="description" id="description" cols="30" rows="5"></textarea>
                </div>
              </div>
